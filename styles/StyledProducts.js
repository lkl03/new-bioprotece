...
export const MedH3 = styled.h3 `
    color: #06C1A0;
`

export const IntroMedContainer = styled.div `
    display: grid;
    width: 80%;
    margin-top: 2rem;
`

export const MedDesc = styled.p `
    text-align: center;
    width: 75%;
    margin: auto;
`
...
export const ContainerSecond = styled.div `
    ...
    justify-content: space-between;
`
export const ContainerFirstTexto = styled.div `
    display: flex;
    flex-direction: column;
    flex-basis: 40%;
    margin-top: 2rem;
    text-align: start;
`
export const ContainerSecondTexto = styled.div `
    display: flex;
    flex-direction: column;
    flex-basis: 40%;
    margin-top: 2rem;
    text-align: end;
`
export const ContainerFirstImg = styled.img `
    flex-basis: 25%;
    height: 300px;
`
export const ContainerSecondImg = styled.img `
    flex-basis: 25%;
    height: 300px;
`
