import { ListaPlus, ListaNormal } from "../../../components/Equipamiento/Lists/ListEndomedular";
import {
  ProductSection,
  Container,
  Title,
...
const categoria = "clavos endomedulares";
        ...
        <Container>
          <Cards>
            {ListaPlus.map((item, index) => {
              return (
                <>
                  <Link href={`/productos/clavos-endomedulares/${item.id}`}>
                    <CardPlus key={index}>
                      <ImgCard
                        src={item.img}
