...
const Sincabeza = () => {
    ...
    const titulo = 'Tornillo para calcáneo sin cabeza';
    const img = 'calcaneo-sincabeza';


    return (
        <>
            <Redirecter category="Tornillos" product="Tornillo para calcáneo sin cabeza" />
            <NavProd />
            <ItemS>
