import { ListaPlus, ListaNormal } from "../../../components/Equipamiento/Lists/ListOsteo3.js";
import {
  ProductSection,
  Container,
  Title,
...
const categoria = "osteosíntesis 3.5";
        ...
        <Container>
          <Cards>
            {ListaPlus.map((item, index) => {
              return (
                <>
                  <Link href={`/productos/osteosintesis-3-5/${item.id}`}>
                    <CardPlus key={index}>
                      <ImgCard
                        src={item.img}
