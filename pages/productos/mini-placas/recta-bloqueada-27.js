...
const PlacaEnL = () => {
    ...
    const titulo = 'Placa recta bloqueada titanio 2.7';
    const img = 'placa-recta';
    ...
    return (
        <>
            <Redirecter category="Mini Placas" product="Placa recta" />
            <NavProd />
            <ItemS>
                    ...
                    <div className="info-div">
                        ...
                        <table className="tabla-chica" data-aos="fade-left">
                            ...
                            <tbody className="table-hover">
                                <tr>
                                    <td className="text-left code">43-049</td>
